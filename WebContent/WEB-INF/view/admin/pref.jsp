      ...
      <td> 
        ...
        <div class="vprubrikhead"><%-- Pr&auml;ferenzen --%><bean:message key="admintext.pref.rubrik"/>
          ...
          <table class="vpf" bgcolor="#F5F5F5" width="100%" border="0" cellspacing="0" cellpadding="5">         
            ...
            <tr>              				
				<td>
					<c:if test='${not empty sessionScope.prefs.show_deliverkind_not_applicabl}'> 
					  <input type='checkbox' name='show_deliverkind_not_applicabl' checked />
					</c:if>
					<c:if test='${empty sessionScope.prefs.show_deliverkind_not_applicabl}'> 
					  <input type='checkbox' name='show_deliverkind_not_applicabl' />
					</c:if>
				</td>
				<td valign="middle">
					<a href='javascript:popupGross("images//shop_prefs_ordertext.gif", "Details")' class="SpNameLink">
