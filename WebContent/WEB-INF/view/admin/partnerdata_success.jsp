...
<!-- Beginn VP --> 
	<div class="vpf">
		<div class="vprubrikhead"><%-- Speichern erfolgreich! --%><bean:message key="admintext.partnerdata_success.rubrik"/> 
		...
		<div class="vpheadsub">
		<%-- Speichern erfolgreich - Speichern der Partnerdaten war erfolgreich!
		 --%><bean:message key="admintext.partnerdata_success.head"/>
		</div>			
		<br/>
		<div class="vpf">	
			    <%-- Klicken Sie im Menu links für weitere Aktionen.
				 --%><bean:message key="admintext.partnerdata_success.text1"/>			
		</div>    	</td>  	</tr>
		</table>
