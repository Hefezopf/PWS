                  ...
                  <tbody>
                    <tr> 
                      <td class="shopHeaderRow1" align="left" valign="top" width="25%">
					    <b><!-- Infos f&uuml;r die Bestellung --><bean:message key="shoptext.order_info_acktitleorderinfo"/></b>
				      </td>
                     </tr>
                    <tr> 
                      <td align="left" valign="top" class="shopHeaderRow2" width="88%"> 
                        <!-- Bitte best&auml;tigen Sie hier Ihre Bestellung.<br/>
                        Das Absenden Ihrer Bestelllung ist bindend und es kommt 
                        stillschweigend ein Kaufvertrag zustande.
						 --><bean:message key="shoptext.order_info_ackorderinfo"/>
					  </td>
                     </tr>
                  </tbody>
                </table></td>
                  ...
                  <tbody>
                    <tr> 
                      <td class="shopHeaderRow1" align="left" valign="top" width="28%">
					     <b><!-- Bestelltext --><bean:message key="shoptext.order_info_acktitleordertext"/></b>
					  </td>
                    </tr>
                    <tr> 
                      <td align="left" valign="top" class="shopHeaderRow2" width="28%">${sessionScope.prefs.bestelltext}
					  </td>
                    </tr>
                  </tbody>
                </table></td>
